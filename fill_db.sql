...
-- --                         2. ВРАЧИ                            --
-- -----------------------------------------------------------------
INSERT INTO doctors (doctor_id, full_name, specialization, login, password_hash, status) VALUES
(1, 'Иванов Иван Иванович', 'Терапевт', 'doctor1', '$2a$10$Ogm9H9WRItgoSLC7sfDIheQ6ud00GWN0Ndg2w2wPVEu1RxxnyaHdK', 'активен'),
(2, 'Петров Петр Петрович', 'Хирург', 'doctor2', '$2a$10$XHUAWmQiayknMp1dgvBwt.NLjnJoLsWEIClIODRKAvmKU8bJQ1qzK', 'активен'),
(3, 'Смирнова Мария Викторовна', 'Кардиолог', 'doctor3', '$2a$10$U0egnaUCex5RAJZFIi2/Tel841A5/TV.0SAAFryJKBg4BrHQSknTG', 'перерыв'),
(4, 'Кузнецова Ольга Дмитриевна', 'Невролог', 'doctor4', '$2a$10$IMcnMECCHktv76wW4.gLgePxTyS0pDf3zIp8TgOTeW05XoV2heBHa', 'неактивен')
...
-- =================================================================
-- Удаляем старое расписание перед вставкой нового
...
FROM generate_series('2025-07-01'::timestamp, '2025-07-31'::timestamp, '1 day'::interval) AS day
CROSS JOIN generate_series('2025-01-01 10:00'::timestamp, '2025-01-01 15:30'::timestamp, '30 minutes'::interval) AS ts
