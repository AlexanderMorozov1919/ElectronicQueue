...
// GetSchedule proxies the request to the 1C service to get a patient's appointment time.
...
func (h *OneCHandler) GetSchedule(c *gin.Context) {
	...
	data, err := h.service.GetSchedule(phone)
	if err != nil {
...
// GetDoctorSchedule proxies the request to the 1C service to get the general schedule.
...
func (h *OneCHandler) GetDoctorSchedule(c *gin.Context) {
	data, err := h.service.GetDoctorSchedule()
	if err != nil {
